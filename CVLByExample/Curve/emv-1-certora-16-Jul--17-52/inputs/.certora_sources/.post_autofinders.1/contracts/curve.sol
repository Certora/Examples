...
contract curve is ReentrancyGuard{
    ...
    {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00240000, 1037618708516) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00240001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00240002, 0) }
        return getVirtualPrice();
    }

    function sample_view_functions() internal{assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00200000, 1037618708512) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00200001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00200002, 0) }
        // Sample the values
    ...
    function get_D(uint256[2] memory xp,uint256 amp) public view returns(uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00230000, 1037618708515) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00230001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00230003, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00236001, amp) }
        uint256 S = 0;
        uint256 Dprev = 0;
    ...
    function _A() view internal returns(uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00210000, 1037618708513) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00210001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00210002, 0) }
    ...
    function _balances(uint256 _value) public view returns(uint256[2] memory) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00220000, 1037618708514) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00220001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00220003, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00226000, _value) }
        return [
            address(this).balance - admin_balances[0] - _value,
            ERC20(coins_1).balanceOf(address(this)) - admin_balances[1]];
    }

    function getVirtualPrice() public view returns(uint256){assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00250000, 1037618708517) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00250001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00250002, 0) }
    ...
    function remove_liquidity(
        ...
        logInternal38(_min_amounts)nonReentrant 
        public 
        returns(uint256[2] memory) 
    {
        ...
        return amounts;
    }modifier logInternal38(uint256[2] memory _min_amounts) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00260000, 1037618708518) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00260001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00260003, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00266001, _min_amounts) } _; }
...
contract attacker{
    ...
    function exec() public {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001f0000, 1037618708511) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001f0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001f0002, 0) }
    // prepare token
