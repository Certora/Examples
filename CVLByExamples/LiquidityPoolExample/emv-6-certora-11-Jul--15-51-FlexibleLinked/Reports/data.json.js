						...
						"callResolution":[
							{
								 "tableRow": {
									...
									"comments":[
										{
											"alternative callees": "[FlexibleReceiver | TrivialReceiver]"
										},
										{
		 ...
		 "availableContractsTable": {
			...
			"contractResult":[
				...
				},
				{
					 "tableRow": {
						"name": "Pool",
						"address": "ce4604a000000000000000000000001b",
						"pre_state": "{4=274184521717934524641157099916833587217}",
						"methodsNames":[
							"deposit(uint256)",
							"calcPremium(uint256)",
							"transferFrom(address,address,uint256)",
				...
				},
				{
					 "tableRow": {
						...
						"pre_state": "{101=274184521717934524641157099916833587227}",
						"methodsNames":[
