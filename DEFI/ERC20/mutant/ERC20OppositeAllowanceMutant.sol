...
// WARNING: Allowance BUG
// The following ERC20 implementation contains a Allowance bug in the `transferFrom` function.
// The `transferFrom` function check the allowance in opposite direction.
...
contract ERC20 {
    ...
    function transferFrom(
        ...
        //bug _allowances[from][msg.sender] => _allowances[msg.sender][from]
        uint256 allowed = _allowances[msg.sender][from]; // Saves gas for limited approvals.
